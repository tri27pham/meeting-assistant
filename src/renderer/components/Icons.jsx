...
// Audio meter / volume level icon
export function MeterIcon({ className = '' }) {
  return (
    <svg 
      className={className}
      width="16" 
    ...
    >
      ...
      <rect x="5" y="7" width="2" height="7" rx="0.5" fill="currentColor" opacity="0.7"/>
      <rect x="8" y="4" width="2" height="10" rx="0.5" fill="currentColor" opacity="0.8"/>
